...
pip install -U torch torchvision pytorch-lightning docker hydra-core h5py ax-platform evotorch optuna plotly matplotlib scipy numpy pandas raypyng wandb
