...
method_dict = {"Smart Walker": (optimize_smart_walker, 1000), "Monte Carlo": (optimize_brute, 1000), "TPE": (optimize_tpe, None), "Blop": (optimize_blop, 1), "PSO": (optimize_pso, 1000), "SNES": (optimize_evotorch, 1000)}
