...
def evaluate_evaluation_method(method, model, observed_rays, uncompensated_parameters, offsets, max_offset=0.2, iterations=1000, repetitions=10):
    loss_list = []
    loss_min_tens_list = []
    loss_min_params_list = []
    for i in range(repetitions):
        loss_min_params, loss, loss_min_list = method(model, observed_rays, uncompensated_parameters, iterations=iterations, max_offset=max_offset)
